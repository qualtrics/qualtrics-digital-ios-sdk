...
///
/// \param otherAnswerTextColor Text adaptive color for <code>other</code> option in multiple choice question
///
...
///
- (nonnull instancetype)initWithQuestionTextColor:(UIColor * _Nonnull)questionTextColor questionTextFont:(UIFont * _Nonnull)questionTextFont otherAnswerTextColor:(UIColor * _Nonnull)otherAnswerTextColor otherAnswerTextFont:(UIFont * _Nonnull)otherAnswerTextFont otherAnswerBackgroundColor:(UIColor * _Nonnull)otherAnswerBackgroundColor radioButtonsTheme:(RadioButtonTheme * _Nonnull)radioButtonsTheme OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
